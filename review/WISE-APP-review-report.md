...
2. **Release Readiness & UX:** Export is limited to two threshold-table CSV buttons (UI-23), configuration cannot be saved/restored (UI-24), flyout/a11y gaps (UI-02/03/10), and Step 1/2 run buttons were silently no-oping without prerequisites (UI-29 ✅ closed 2026-09-02: buttons disable with prerequisite explanations).
